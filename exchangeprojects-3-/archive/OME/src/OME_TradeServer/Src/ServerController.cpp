...
{
	SendSignal(SERVER_OME, SIGNAL_TYPE_STARTUP, SIGNAL_STATUS_STARTING);
	...
	SendSignal(SERVER_OME, SIGNAL_TYPE_STARTUP, SIGNAL_STATUS_PORTS_READY);
	...
	SendSignal(SERVER_OME, SIGNAL_TYPE_STARTUP, SIGNAL_STATUS_BO_UP);

	SendSignal(SERVER_OME, SIGNAL_TYPE_STARTUP, SIGNAL_STATUS_EXTERNAL_CONNS_UP);

	// Start the KA Server
	StartKAthread(SERVER_OME);
