...
//typedef struct OHLCSTATS
//{
//	unsigned long long m_lastTradePrice;
//	unsigned long long m_lastTradeVolumn;
//	double m_lastTradeTime;
//	unsigned long long m_openPrice;
//	unsigned long long m_highPrice;
//	unsigned long long m_lowPrice;
//	unsigned long long m_closePrice; //Average of last 10 trade
//
//}OHLCStats;
...
private:
	...
	//typedef pair<string,MARKET_ORDER_LIST>					KEY_VALUE_PAIR;
