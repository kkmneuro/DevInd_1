...
{
protected:
	IRMSCalculator *m_pFXCalculator;
	IRMSCalculator *m_pFUTCalculator;
public:
	...
	virtual double CalculateProfit(unsigned long long LastPx, double AvgPx,	unsigned long long, char side, symbol& sym, unsigned long ullContractSize) = 0;	
};
