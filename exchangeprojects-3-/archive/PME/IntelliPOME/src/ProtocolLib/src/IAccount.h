...
public:
	...
	// 4. DPR Range
	virtual int ProcessNewOrder(IOrder *ord, IContractManager *pContractManager) = 0;
	...
	// 3. Maximum Allowable position (Contract Specs)
	// 4. DPR Range
	virtual int ProcessCROrder(IOrder *ord, IOrder *pNewOrder, IContractManager *pContractManager) = 0;
...
public:
	...
	virtual int CheckMargin(IOrder *ord, unsigned long long Qty, IContractManager *pContractManager, IPosition *pPosition) = 0;
