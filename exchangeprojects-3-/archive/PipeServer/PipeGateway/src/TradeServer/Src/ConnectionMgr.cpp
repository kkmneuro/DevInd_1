...
{	
	...
	stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::ConnectionMgr, Exit");
...
void ConnectionMgr::OnMsgRecv(unsigned int clientId,void* msg,unsigned int msgtype)
{
	...
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::OnMsgRecv, Exit");
}
void ConnectionMgr::ProcessNextRequest(unsigned int clientId,void* msg,unsigned int msgtype)
{
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::ProcessNextRequest, Entered");

	OnMsgRecv(clientId, msg, msgtype);

	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::ProcessNextRequest, Exit");
}
...
{
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::ProcessRequest, Entered");
	ProcessBLRequest(msg);
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::ProcessRequest, Exit");
}
...
void ConnectionMgr::ProcessBLRequest(MESSAGE msg)
{
	...
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::ProcessBLRequest, Exit");
}
...
void ConnectionMgr::SendResponseToProtocol(MESSAGE msg)
{
	...
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::SendResponseToProtocol, Exit");
}

void ConnectionMgr::SendResponseToQueue(unsigned int clientId,void* msg,unsigned int msgtype)
{
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::SendResponseToQueue, Entered");
	...
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::SendResponseToQueue, Exit");
}
...
void ConnectionMgr::RemoveConnection(unsigned int clientId)
{
	...
	stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::RemoveConnection, Exit");
}
...
void ConnectionMgr::OnConnectionStatus(unsigned int clientId, bool connect, char* clientIp, unsigned short clientPort)
{
	...
	stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::OnConnectionStatus, Exit");
}
...
IClientSession* ConnectionMgr::GetClientSession(unsigned clientID)
{
	...
	//stl::log::trace(stl::log::LOG_GROUP_ERROR, stl::log::LOG_LEVEL_DEBUG, "ConnectionMgr::GetClientSession, Exit");
}
