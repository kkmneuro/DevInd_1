...
private:
	...
	typedef std::queue<MESSAGE>							QUEUE_REQUEST_MSG;
	typedef std::queue<MESSAGE>							QUEUE_RESPONSE_MSG;
	typedef std::map<unsigned long long, MESSAGE>		MAP_RESPONSE_MSG;
...
//	QUEUE_RESPONSE_MSG								m_queueResponseMsg;
	...
	IServerProtocol*								m_serverProtocolNormal;
