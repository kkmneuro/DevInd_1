...
namespace DataAcessLogic.DBML
{
	...
	public partial class dbMan_BO_GetTradeReportDataByOrderTypeDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void OnCreated();
		...
		public dbMan_BO_GetTradeReportDataByOrderTypeDataContext() : 
				base(global::DataAcessLogic.Properties.Settings.Default.OMSExchangeConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public dbMan_BO_GetTradeReportDataByOrderTypeDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbMan_BO_GetTradeReportDataByOrderTypeDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbMan_BO_GetTradeReportDataByOrderTypeDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public dbMan_BO_GetTradeReportDataByOrderTypeDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.OMS_GetTradeReportDataByOrderType")]
		public ISingleResult<OMS_GetTradeReportDataByOrderTypeResult> OMS_GetTradeReportDataByOrderType([global::System.Data.Linq.Mapping.ParameterAttribute(Name="OrderType", DbType="VarChar(50)")] string orderType, [global::System.Data.Linq.Mapping.ParameterAttribute(Name="BrokerID", DbType="Int")] System.Nullable<int> brokerID)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), orderType, brokerID);
			return ((ISingleResult<OMS_GetTradeReportDataByOrderTypeResult>)(result.ReturnValue));
		}
	}
	
	public partial class OMS_GetTradeReportDataByOrderTypeResult
	{
		...
		public OMS_GetTradeReportDataByOrderTypeResult()
		{
		}
