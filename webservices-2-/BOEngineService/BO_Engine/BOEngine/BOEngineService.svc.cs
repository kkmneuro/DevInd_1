...
namespace BOEngine
{
    ...
    public class BOEngineService : IBOEngineService
    {
        ...
        public clsLogin AuthenticateLogin(string loginPwd, clsLogin login, string ipAddress)
        {
            ...
            {
                LogManager.LogManagerInstance.syncLog("Exception :BOEngineService => Type " + ex.GetType().FullName + "ExceptionMessage " + ex.Message +
                    ...
                    case OperationTypes.GET:
                        {
                            ...
                            {
                                clsTGAccountConnectionSettings objclsTGACSettings = new clsTGAccountConnectionSettings();
