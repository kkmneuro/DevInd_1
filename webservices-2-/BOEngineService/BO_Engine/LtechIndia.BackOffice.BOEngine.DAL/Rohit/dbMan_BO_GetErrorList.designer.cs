...
namespace LtechIndia.BackOffice.BOEngine.DAL.Rohit
{
    ...
    partial void OnCreated();
		...
		[Function(Name="dbo.BO_GetErrorString")]
		public int BO_GetErrorString([Parameter(Name="ErrorNumber", DbType="BigInt")] System.Nullable<long> errorNumber, [Parameter(Name="ErrorString", DbType="NVarChar(MAX)")] ref string errorString)
		{
