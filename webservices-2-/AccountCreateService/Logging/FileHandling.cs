...
namespace Logging
{
    ...
    class Logger : IDisposable,IMsgProcessor<Message>
    {
...
#if USE_LOCAL_TIME
                workingDir = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/CreateAccountServiceLog/Logs" + "/Log_" + DateTime.Now.ToString("dd_MM_yyyy");
#else
                workingDir = "./Log_" + DateTime.UtcNow.ToString("dd_MM_yyyy");
#endif

                strCounter = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/CreateAccountServiceLog/Logs/Counter.txt";
                lock (lckSetting)
                    loadSetting();
        ...
        {
#if USE_LOCAL_TIME
            string temp = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/CreateAccountServiceLog/Logs" + "/Log_" + DateTime.Now.ToString("dd_MM_yyyy");
#else
