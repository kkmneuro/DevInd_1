...
namespace CommonLibrary.Cls
{
    public class ClsCommonMethods
    {
        ...
        {
            var mydialog = new NTaskDialog { Title = ProductName };
        ...
        public static void SaveGridDataInExcel(string fileName, UctlGrid gridControl)
        {
            ...
            var document = new ExcelDocument { UserName = "VinodKumarVarma", CodePage = CultureInfo.CurrentCulture.TextInfo.ANSICodePage };
