...
namespace CommonLibrary.UserControls
{
    public partial class UctlNetPosition : UctlBase
    {
        ...
        {
            if (ui_pnlFilter.Visible)
            {
                ui_pnlFilter.Visible = false;
            }
            else
            {
                ui_pnlFilter.Visible = true;
            }
        }
        ...
        public void AddColumnsToGrid()
        {
            ...
            columnsArray[6] = ClsCommonMethods.CreateGridColumn(columnsArray[6], "clmSeriesExpiry", "Series/Expiry", false);
            ...
            columnsArray[10] = ClsCommonMethods.CreateGridColumn(columnsArray[10], "clmProductName", "Product Name", false);
            ...
            columnsArray[12] = ClsCommonMethods.CreateGridColumn(columnsArray[12], "clmBuyVal", "Buy Val.", false);
            columnsArray[12].Width = 90;
            ...
            columnsArray[14].Width = 90;
            columnsArray[14].DataPropertyName = "SellQty";
            columnsArray[15] = ClsCommonMethods.CreateGridColumn(columnsArray[15], "clmSellVal", "Sell Val.", false);
            ...
            columnsArray[17].Width = 90;
            columnsArray[17].DataPropertyName = "NetQty";
            columnsArray[18] = ClsCommonMethods.CreateGridColumn(columnsArray[18], "clmNetVal", "Net Val.", false);
            columnsArray[18].DataPropertyName = "NetVal";
            columnsArray[19] = ClsCommonMethods.CreateGridColumn(columnsArray[19], "clmNetPrice", "Realized Profit", false);
            columnsArray[19].Width = 90;
            columnsArray[19].DataPropertyName = "NetPrice";
            columnsArray[20] = ClsCommonMethods.CreateGridColumn(columnsArray[20], "clmMarketPrice", "Market Price", false);
            columnsArray[20].Width = 90;
        ...
        public event Action OnSearchFieldChanged = delegate { };
        public event Action OnSquareOffClick = delegate { };
        ...
        private void uctlNetPosition_Load(object sender, EventArgs e)
        {
            CreateContextMenu();
            SetLocalization();
            ui_uctlGridNetPosition.AutoSizeColumsMode = DataGridViewAutoSizeColumnsMode.Fill;
        }
        ...
        private void ui_pnlFilter_VisibleChanged(object sender, EventArgs e)
        {
            if (ui_pnlFilter.Visible)
            {
        ...
        {
            if (ui_ncmbContracts.SelectedIndex > -1)
            {
                OnSearchFieldChanged();
            }
        }
