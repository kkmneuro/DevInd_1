...
namespace CommonLibrary.UserControls
{
    public partial class UctlOrderBook : UctlBase
    {
        ...
        public bool _isAccountNoChanged = true;
        ...
        #region    "        METHODS           "
        public ToolStripMenuItem[] ContextMenuItems = new ToolStripMenuItem[6];
        /// <summary>
        ...
        public void AddColumnsToGrid()
        {
            ...
            columnsArray[14] = ClsCommonMethods.CreateGridColumn(columnsArray[14], "clmValidity", "Validity");
            columnsArray[14].DataPropertyName = "TimeInForce";

            columnsArray[15] = ClsCommonMethods.CreateGridColumn(columnsArray[15], "clmDisclosedQuantity",
                                                                 "Disclosed Quantity");
            columnsArray[15].DefaultCellStyle = intCellStyle;

            columnsArray[16] = ClsCommonMethods.CreateGridColumn(columnsArray[16], "clmLastModifiedTime",
                                                                 "Last Modified Time", false);

            columnsArray[17] = ClsCommonMethods.CreateGridColumn(columnsArray[17], "clmAvgPrice", "Average Price");
            columnsArray[17].DataPropertyName = "AvgPrice";
            columnsArray[17].DefaultCellStyle = intCellStyle;

            columnsArray[18] = ClsCommonMethods.CreateGridColumn(columnsArray[18], "clmCommission", "Commission");
            columnsArray[18].DataPropertyName = "Commission";
            columnsArray[18].DefaultCellStyle = intCellStyle;

            columnsArray[19] = ClsCommonMethods.CreateGridColumn(columnsArray[19], "clmTax", "Tax");
            ...
            columnsArray[22] = ClsCommonMethods.CreateGridColumn(columnsArray[22], "clmAccountType", "Account Type",
                                                                 false);

            columnsArray[23] = ClsCommonMethods.CreateGridColumn(columnsArray[23], "clmClientName", "Client Name", false);

            columnsArray[24] = ClsCommonMethods.CreateGridColumn(columnsArray[24], "clmPartIdOmniId", "Part Id/Omni Id",
                                                                 false);
            ...
            columnsArray[26] = ClsCommonMethods.CreateGridColumn(columnsArray[26], "clmGoodTillDate", "Good Till Date",
                                                                 false);
