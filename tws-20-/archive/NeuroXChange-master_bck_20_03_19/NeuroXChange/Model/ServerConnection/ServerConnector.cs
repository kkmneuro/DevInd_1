...
namespace NeuroXChange.Model.ServerConnection
{
    public class ServerConnector
    {
        ...
        public bool Connect()
        {
            ...
            this.model.WsHelperQuotes.Init(UserLogin, UserPassword, "ws://40.117.144.146:9033");
            //await Task.Delay(2000);

            this.model.WsHelperOrders.OnLogonResponse += new Action<string, string>(INSTANCE_OnLogonResponceOrders);
            this.model.WsHelperOrders.Init(UserLogin, UserPassword, "ws://40.117.144.146:9030");
            //await Task.Delay(2000);           
