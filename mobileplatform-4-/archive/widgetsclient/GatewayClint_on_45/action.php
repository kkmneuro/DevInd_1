...
<?php
 ...
 //echo file_get_contents("http://192.168.1.84:83/RestServiceImpl.svc/AuthenticateUser/test2/password2/4");
	...
	//$tockenidfind = file_get_contents(ApiURL."AuthenticateUser/test/password/1"); // For 84
	$tockenidfind = file_get_contents(ApiURL."AuthenticateUser/test2/password2/3"); // For 45
...
if(count($_POST>0) && isset($_POST['AuthenticateUser']))
		{
			...
			//echo ApiURL."AuthenticateUser/".$username."/".$password."/".$TCInstanceId;die;
...
if(count($_POST>0) && isset($_POST['CurrencyConversion']))
		{
			$managerId = $_POST['managerId']; 
			$TCInstanceId = $_POST['TCInstanceId'];
			$TCGatewayId = $_POST['TCGatewayId'];
			...
			$HitURL = ApiURL."CurrencyConversion/".$tockenid."/".$managerId."/".$TCInstanceId."/".$TCGatewayId."/".$Amount."/".$SourceCurrency."/".$DestinationCurrency;
			$WebserviceDetails = file_get_contents($HitURL);
				
		}
if(count($_POST>0) && isset($_POST['GroupSymbolInfo']))
		{
			$managerId = $_POST['managerId']; 
			$TCInstanceId = $_POST['TCInstanceId'];
			$TCGatewayId = $_POST['TCGatewayId'];
						
			$HitURL = ApiURL."GroupSymbolInfo/".$tockenid."/".$managerId."/".$TCInstanceId."/".$TCGatewayId;
			$WebserviceDetails = file_get_contents($HitURL);
