...
<table border="0" class="hideid12" style="background-color:#FFF; color:#BFBBBB; width:1020px;font-size: 13px;border-collapse: collapse;">
<tr height="30px" style="border: #dae0e8 1px solid;">
<th width="425px" >Live quotes</th>
<th width="100px">Average spread</th>
<th width="385px">Trading Sessions Average Pip</th>
<th width="116px"  style="color:#000000" >Trading Clock</th>
</tr>
<tr height="30px">
<th></th>
<th></th>
<th></th>
<th style="border: #dae0e8 1px solid;width: 13%;">
...
<div class="hideid13">
<table border="0" style="background-color:#FFF; color:#BFBBBB;font-size: 13px;border-collapse: collapse;    margin-top: 220px;">
<tr height="30px" style="border: #dae0e8 1px solid;">
<th></th>
</tr>
</table>
...
function OutputLog(msg){
			...
			if(document.getElementById(ss2)){
                ...
                else if (b1 == b2)
                {
                    if ($(window).width() < 500) 
					{
						document.getElementById(ss2+'_bid').style.color = '#000000';
					} else {
                ...
                else if (a1 == a2)
                {
					...
					if ($(window).width() < 500) 
					{
						document.getElementById(ss2+'_ask').style.color = '#000000';
					} else {
				...
				if ($(window).width() < 500) {
				   //alert('Less than 500');
				   var content = '<tr class=\"trcssstyle\"><td class=\"sym\">Symbol</td><td class=\"bd\"> Bid</td><td class=\"as\" >Ask</td></tr><tr class=\"trcssstyle\"><td class=\"symsmall\" id="'+ss2+'" >' + symbol + '</td><td  class=\"bdsmall\" id="'+ss2+'_bid">' + bid + '</td><td class=\"assmall\" id="'+ss2+'_ask">' + ask + '</td></tr><tr class=\"trcssstyle\"><td class=\"spsmall\" >Spread </td><td class=\"avsmall\">Average</td><td class=\"tok\" >Tokyo</td></tr><tr class=\"trcssstyle\"><td class=\"spsmall\" id="'+ss2+'_spread">' + spread  + '</td><td class=\"avsmall\" id="'+ss2+'_average">' + average + '</td><td class=\"tok\" id="'+ss2+'_Tokyo">' + average + '</td></tr><tr class=\"trcssstyle\"><td class=\"sysmall\" >Sydney</td><td class=\"lonsmall\" >London</td><td class=\"nysmall\" >NY</td><tr><tr class=\"trcssstyle\"><td class=\"sysmall\" id="'+ss2+'_Sydney">' + average + '</td><td class=\"lonsmall\" id="'+ss2+'_London">' + average + '</td><td class=\"nysmall\" id="'+ss2+'_NY">' + average + '</td><tr>';
				
				$('#consolebox').append(content);
				$('.hideid12').css("display","none");
				$('.hideid13').css("display","block");
				}
				else {
				   //alert('More than 600');
...
if ($(window).width() < 500) {
				  // alert('Less than 500');
				   ...
				   //alert('Less than 500');
				   var headermenu = '<tr class=\"trcssstyle\"><th class=\"sym\">SYMBOL</th><th class=\"bd\">Bid</th><th class=\"as\">Ask</th><th class=\"sp\">Spread</th><th class=\"av\">Average</th><th class=\"tok\">Tokyo</th><th class=\"sy\">Sydney</th><th class=\"lon\">London</th><th class=\"ny\">NY</th></tr>';
					$('#consolebox').append(headermenu);
					$('.hideid13').css("display","none");
				}
...
<form action="full_symbols.php" method="get">
<input type="submit" value="Show full list  + " name="showme" class="buttonAll" />
</form>
