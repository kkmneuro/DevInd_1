...
namespace CommonLibrary.UserControls
{
    public partial class FrmCustomize : NForm
    {
        ...
        ///// <summary>
        ///// Called when the selected item of the Visible column list is changed
        ///// </summary>
        ///// <param name="sender"></param>
        ///// <param name="e"></param>
        //private void ui_nlstVisibleColumns_SelectedIndexChanged(object sender, EventArgs e)
        //{
        //    if (ui_nlstColumns.SelectedItem != null)
        //    {
        //        ui_ntxtColHeaderText.Text = ((uctlGrid)_obj).Columns[ui_nlstColumns.SelectedItem.ToString()].HeaderText;
        //    }
        //}
        ///// <summary>
        ///// Method for moving items from left list to right list
        ///// </summary>
        ///// <param name="sender"></param>
        ///// <param name="e"></param>
        //private void left_Click(object sender, EventArgs e)
        //{
        //    for (int i = 0; i < ui_nlstColumns.SelectedItems.Count; i++)
        //    {
        //        if (!ui_nlstInVisibleColumns.Items.Contains(ui_nlstColumns.SelectedItems[i].ToString()))
        //        {
        //            ui_nlstInVisibleColumns.Items.Add(ui_nlstColumns.SelectedItems[i].ToString());
        //            ui_nlstColumns.Items.Remove(ui_nlstColumns.SelectedItems[i].ToString());
        //        }
        //    }
        //}
        ///// <summary>
        ///// Method for moving items from right list to left list
        ///// </summary>
        ///// <param name="sender"></param>
        ///// <param name="e"></param>
        //private void right_Click(object sender, EventArgs e)
        //{
        //    for (int i = 0; i < ui_nlstInVisibleColumns.SelectedItems.Count; i++)
        //    {
        //        if (!ui_nlstColumns.Items.Contains(ui_nlstInVisibleColumns.SelectedItems[i].ToString()))
        //        {
        //            ui_nlstColumns.Items.Add(ui_nlstInVisibleColumns.SelectedItems[i].ToString());
        //            ui_nlstInVisibleColumns.Items.Remove(ui_nlstInVisibleColumns.SelectedItems[i].ToString());
        //        }
        //    }
        //}
        /// <summary>
