...
namespace CommonLibrary.UserControls
{
    public partial class UctlForex : UctlBase //, IQuoteSubscriber
    {
        ...
        public bool AddForexPair(string key, string symbol)
        {
            ...
            pair.OnBuyClick += new Action<string, string, double, int>(pair_OnBuyClick);
            pair.OnBuyMarketClick += new Action<string, string, double, int>(pair_OnBuyMarketClick);
            pair.OnCloseClick += new Action(pair_OnCloseClick);
            pair.OnSellClick += new Action<string, string, double, int>(pair_OnSellClick);
            pair.OnSellMarketClick += new Action<string, string, double, int>(pair_OnSellMarketClick);
        ...
        void pair_OnSellMarketClick(string key, string account, double price, int qty)
        {
            //key,account,price,qty
            OnSellMarketClick(key, account, price, qty);
        }

        void pair_OnSellClick(string key, string account, double price, int qty)
        {
        ...
        void pair_OnBuyMarketClick(string key, string account, double price, int qty)
        {
            OnBuyMarketClick(key, account, price, qty);
        }

        void pair_OnBuyClick(string key, string account, double price, int qty)
        {
        ...
        public event Action<string, string, double, int> OnSellMarketClick;
        public event Action<string, string, double, int> OnSellClick;
        public event Action OnCloseClick;
        public event Action<string, string, double, int> OnBuyMarketClick;
        public event Action<string, string, double, int> OnBuyClick;
