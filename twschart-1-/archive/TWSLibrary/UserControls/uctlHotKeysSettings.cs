...
namespace CommonLibrary.UserControls
{
    public partial class UctlHotKeysSettings : UctlBase
    {
        ...
        public override void SetLocalization()
        {
            ...
            ui_lblOrderEntry.Text = ClsLocalizationHandler.Buy + " " + ClsLocalizationHandler.Order + " " +
        ...
        public clsHotKeySettings GetValues()
        {
            ...
            objclsHotKeySettings.PlaceOrderHotKey = PLACE_ORDER.Text;
            //objclsHotKeySettings.PlaceBuyOrderHotKey = PLACE_ORDER.Text;
        ...
        {
            PLACE_ORDER.Text = HotKeysSettings.PlaceOrderHotKey;
