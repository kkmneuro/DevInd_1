    ...
    public partial class UctlForexPair : UctlBase
    {
        ...
        private void HandleMouseEvent(object sender, Label lbl, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left && e.Clicks == 2)
            {
                if (lbl.Text == "BUY")
                {
                    if (!((uctlQuickOrderContainer)Parent).isBuyOnSingleClick)
                    {
                        onClickBuy();
                    }
                }
                ...
                {
                    if (!((uctlQuickOrderContainer)Parent).isSellOnSingleClick)
                    {
                        onClickSell();
                    }
                }
        ...
        private void lblTypeBottomValueLeft_Click(object sender, EventArgs e)
        {
