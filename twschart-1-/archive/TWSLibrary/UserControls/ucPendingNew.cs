...
{
    public partial class ucPendingNew : OrderChildControl
    {
        GTS.Frm.frmOrderEntry _parent;
       
        public ucPendingNew(GTS.Frm.frmOrderEntry _frmOrderEntry)
        {
            InitializeComponent();
        ...
        private void cmbTIF_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (cmbTIF.SelectedIndex)
            {
                ...
                case 3:
                    ...
                    dtpickerGTD.Value = DateTime.Now;
