    ...
    public partial class UctlGrid : UctlBase
    {
        ...
        private void ui_mnuSizeToFit_Click(object sender, EventArgs e)
        {
            if (ui_mnuSizeToFit.Checked == false)
            {
                ...
                ui_ndgvGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCellsExceptHeader;
            }
            else
            {
        ...
        private void UctlGrid_Load(object sender, EventArgs e)
        {
            //Kul
            this.ColumnHeadersCellStyle.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        }
    }
