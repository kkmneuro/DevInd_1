...
namespace PALSA.Frm
{
    public partial class FrmProperties : NForm
    {
        ...
        public FrmProperties(string symbol, BarData[] data, ChartProperty cp, double minY, double maxY)
        {
            ...
            //lblAskLine.Visible = colBtnAskLine.Visible = false;
            //lblStopLevels.Visible = colBtnStopLevels.Visible = false;
            //lblSLLine.Visible = nColorBtnSLLine.Visible = false;
            //lblTPLine.Visible = nColorBthTPColor.Visible = false;
            //lblVolume.Visible = colBtnVolume.Visible = false;
        ...
        private void SetLoadChartColor()
        {
            //try
            {
                ...
                StockChartX1.BackGradientTop = Props.backGround;
                StockChartX1.BackGradientBottom = Props.backGround;
                ...
                StockChartX1.LineColor = Props.lineGraph;
        ...
        /// <summary>
        /// used to load chart after removing pervious All Series and Loads new charts
        /// </summary>
        ...
        public void LoadChart(string Symbol, BarData[] Data)
        {
            //try
            {
                StockChartX1.Dock = DockStyle.Fill;
                ...
                StockChartX1.MaxDisplayRecords = 150;//Width / 11;
                StockChartX1.Update();
            }
            // catch (Exception ex)
            {
        ...
        public void AddAllSeries(string Symbol, BarData[] Data)
        {
            ...
            StockChartX1.set_SeriesColor(Symbol + ".close", ColorTranslator.ToOle(Color.Lime));
            //StockChartX1.AddSeries(Symbol + ".volume", SeriesType.stCandleChart, (int)panel);
            //StockChartX1.set_SeriesVisible(m_Symbol + ".% move", false);

            //StockChartX1.AddSeries(Symbol + ".line", SeriesType.stLineChart, (int)panel);
            //StockChartX1.set_SeriesVisible(Symbol + ".line", false);
            ...
            ////StockChartX1.set_SeriesWeight(m_Symbol + ".volume", 1); //By Ratan for removing Volume

            ////Resize the volume panel to make it smaller
            //StockChartX1.set_PanelY1(1, (int)Math.Round(StockChartX1.Height * 0.8));
            // edit - laxman, Set some initial properties
            StockChartX1.LineColor = Color.Red;
            ...
            StockChartX1.CandleUpOutlineColor = Color.Green;
            StockChartX1.CandleDownOutlineColor = Color.Red;
            ...
            StockChartX1.Gridcolor = Color.Silver;
            StockChartX1.ChartForeColor = Color.Black;
            StockChartX1.UpColor = Color.Lime;
            StockChartX1.DownColor = Color.Red;
            StockChartX1.HorizontalSeparatorColor = Color.Silver;
        ...
        private void PreviewChart()
        {
            //try
            {
                ...
                StockChartX1.LineColor = colBtnLineGraph.Color;
        ...
        private void ApplyCommonProperty()
        {
            ...
            //StockChartX1.AutoScroll = chkChartAutoScroll.Checked;
            StockChartX1.Update();
        }
        ...
        /// <summary>
        /// used for background color changed in chart
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            StockChartX1.ChartBackColor = colBtnBackground.Color;
            StockChartX1.BackGradientTop = colBtnBackground.Color;
            StockChartX1.BackGradientBottom = colBtnBackground.Color;
        }

        /// <summary>
        /// used for forground color change
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Used for BtnBarDownColorChanged
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Used for BtnBullCandle Chanegd
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// used for BtnBearCandle changed
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// used for BtnLineGraphColorChanged
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// used for BtnVolumeColorChanged
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
