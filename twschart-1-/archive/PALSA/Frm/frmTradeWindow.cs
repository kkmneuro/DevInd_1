...
//05/03/2012    NAMO         1.Code for columProfile
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace PALSA.Frm
{
    public partial class frmTradeWindow : frmBase
    {
        ...
        private void frmTradeWindow_Load(object sender, EventArgs e)
        {
            ...
            //List<ClientDLL_Model.Cls.Order.ExecutionReport> lstExecutionReport = clsTWSOrderManager.INSTANCE.GetTradeHistory();
            ...
            Action A = () =>
                           {
                               ...
                               //uctlTradeWindow1.ui_uctlGridTradeWindow.DataSource = clsTWSOrderManager.INSTANCE.tradeHistoryDS.dtTradeHistory;
                           };
            if (InvokeRequired)
            {
                BeginInvoke(A);
