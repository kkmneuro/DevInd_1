...
namespace PALSA.Cls
{
	...
	public class InputBox
	{
		...
		private static NForm frmInputDialog;
		private static Label lblPrompt;
		private static NButton btnOK;
		private static NButton btnCancel;
		private static NTextBox txtInput;
		...
		{
			// Create a new instance of the form.
			frmInputDialog = new NForm();
			lblPrompt = new Label();
			btnOK = new NButton();
			btnCancel = new NButton();
			txtInput = new NTextBox();
			...
			frmInputDialog.Name = "InputDialog";
