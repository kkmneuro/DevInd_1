...
namespace PALSA.Cls
{
    ...
    {
        public static double StopLevel = 5;
       ...
       public static string CurrentPortfolio = string.Empty;
        static ClsGlobal()
        {
            LoadBrandInfo();
        ...
        public static void AddNewIndicator(string p)
        {
        ...
        private static void LoadListValues()
        {
            ...
            AddNewIndicator("Linear Regression R-Squared");
            AddNewIndicator("Linear Regression Forecast");
            ...
            AddNewIndicator("Comparative RSI");
        ...
        private static void LoadBrandInfo()
        {
            ...
            try
            {
                ...
                {
                    AboutImage = Properties.Resources.futurex;
                }
