...
namespace PALSA.Cls
{
    public class BidOfferCross : INotifyPropertyChanged
    {
        ...
        internal void Update(BidOfferBase bid, BidOfferBase offer)
        {
        ...
        //}
        void UpdatePrice(double bidPrice, double offerPrice)
        {
            this.Price = string.Format(STRING_FORMAT, bidPrice.ToString(), offerPrice.ToString());
        }
        ...
        //}
        void UpdateSpread(double bidPrice, double offerPrice)
        {
            this.Spread = Math.Abs(bidPrice - offerPrice).ToString();
        }
        #endregion
