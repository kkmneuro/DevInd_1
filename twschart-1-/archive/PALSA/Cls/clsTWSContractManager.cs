...
//14/02/2012	NAMO	    1.Added TWSContactMnager class for ContactManger information Handling
...
namespace PALSA.Cls
{
    public class ClsTWSContractManager
    {
        #region "         MEMBERS          "
        ...
        public void LoadIntialData()
        {
            try
            {
                InstrumentService.ExchangeInstrumentServiceClient InstService = new InstrumentService.ExchangeInstrumentServiceClient();
                InstrumentService.InstrumentData[] InstrumentDataArr = InstService.GetInstrumentSpec(54);
