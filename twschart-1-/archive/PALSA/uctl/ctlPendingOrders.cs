...
{
    public partial class ctlPendingOrders : UserControl
    {
        ...
        private int y;
        public ctlPendingOrders(object objProfiles, string currentProfile)
        {
            InitializeComponent();
            uctlPendingOrder1.Size = ClientSize;
            _objProfiles = objProfiles;
            uctlPendingOrder1.Profiles = objProfiles;
            uctlPendingOrder1.CurrentProfileName = currentProfile;
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            uctlPendingOrder1.CreateContextMenu();
            uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["CloseOrder"].Visible = false;
            ...
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.CellMouseDoubleClick -= new DataGridViewCellMouseEventHandler(ui_ndgvGrid_CellMouseDoubleClick);
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.CellMouseDoubleClick += new DataGridViewCellMouseEventHandler(ui_ndgvGrid_CellMouseDoubleClick);
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.ColumnHeadersDefaultCellStyle = datastyle;
        }
        void ui_ndgvGrid_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            uctlPendingOrder1_HandleModifyOrderClick(null, null);
        }
        private void ctlPendingOrders_Load(object sender, EventArgs e)
        {
            ...
            var columnsArray = new DataGridViewColumn[54];
            ...
            columnsArray[16] = ClsCommonMethods.CreateGridColumn(columnsArray[16], "clmAvgPrice", "Average Price",false);
            ...
            columnsArray[52] = ClsCommonMethods.CreateGridColumn(columnsArray[52], "clmSLPrice", "SL",false);
            columnsArray[52].DataPropertyName = "SLPrice";
            columnsArray[52].DefaultCellStyle = intCellStyle;
            columnsArray[53] = ClsCommonMethods.CreateGridColumn(columnsArray[53], "clmTPPrice", "TP", false);
            columnsArray[53].DataPropertyName = "TPPrice";
            ...
            uctlPendingOrder1.AddColumnsToGrid(columnsArray);
            ...
            //clsTWSOrderManagerJSON.INSTANCE.OnOrderHistoryResponse += INSTANCE_OnOrderHistoryResponse;
            //clsTWSOrderManagerJSON.INSTANCE.OnBusinessLevelReject += INSTANCE_OnBusinessLevelReject;
            uctlPendingOrder1.HandleCancelOrderClick+=new Action<object,EventArgs>(uctlPendingOrder1_HandleCancelOrderClick);
            uctlPendingOrder1.HandleModifyOrderClick+=new Action<object,EventArgs>(uctlPendingOrder1_HandleModifyOrderClick);
            //Namo 21 March
            //clsTWSOrderManagerJSON.INSTANCE.onPendingOrder -= new Action(INSTANCE_OnPendingOrder);
            //clsTWSOrderManagerJSON.INSTANCE.onPositionOpened -= new Action(INSTANCE_OnPositionOpened);
            //clsTWSOrderManagerJSON.INSTANCE.onPendingOrder += new Action(INSTANCE_OnPendingOrder);
            //clsTWSOrderManagerJSON.INSTANCE.onPositionOpened += new Action(INSTANCE_OnPositionOpened);

            if (uctlPendingOrder1.CurrentProfileName != string.Empty)
            {
                OnProfileApplyClick(uctlPendingOrder1.CurrentProfileName);
            }
            ...
            DoubleBuffered(uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid, true);
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.DataBindingComplete -=ui_ndgvGrid_DataBindingComplete;
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.DataBindingComplete += ui_ndgvGrid_DataBindingComplete;
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.ColumnHeaderMouseClick -=ui_ndgvGrid_ColumnHeaderMouseClick;
            uctlPendingOrder1.ui_uctlGridPendingOrder.ui_ndgvGrid.ColumnHeaderMouseClick +=ui_ndgvGrid_ColumnHeaderMouseClick;
            //uctlPendingOrder1.ui_uctlGridPendingOrder.DataSource =clsTWSOrderManagerJSON.INSTANCE.orderHistoryDS.dtOrderHistory.Select("OrderStatus=Working");
            //Namo 21 March
            // uctlPendingOrder1.ui_uctlGridPendingOrder.DataSource = clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders;
        }

        private void INSTANCE_OnPendingOrder()
        {
           Action A = () =>
           {
              if (clsTWSOrderManagerJSON.INSTANCE != null)
               {
                   //Namo 21 March
                //if (clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.DefaultView.Sort != "ClientOrderId Desc")
                //    clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.DefaultView.Sort = "ClientOrderId Desc";
                //uctlPendingOrder1.ui_uctlGridPendingOrder.DataSource = clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.DefaultView.ToTable
                //        ();
        ...
        private void INSTANCE_OnPositionOpened()
        {
            Action A = () =>
            {
                ...
                {
                    //Namo 21 March
                    //lock (clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders)
                    //{
                    //    clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.AcceptChanges();
                    //    if (clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.DefaultView.Sort != "ClientOrderId Desc")
                    //    {
                    //        clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.DefaultView.Sort = "ClientOrderId Desc";
                    //    }
        ...
        {
            DataGridViewColumn newColumn = uctlPendingOrder1.ui_uctlGridPendingOrder.Columns[e.ColumnIndex];
            if (oldColumn == null)
                oldColumn = uctlPendingOrder1.ui_uctlGridPendingOrder.Columns["clmOrderNumber"];
            ...
            //Namo 21 March
            //DataView dv =clsTWSOrderManagerJSON.INSTANCE.pendingOrdersDS.dtPendingOrders.DefaultView;
            //if (uctlPendingOrder1.ui_uctlGridPendingOrder.Columns[e.ColumnIndex].DataPropertyName != string.Empty)
            //{
            //    dv.Sort = uctlPendingOrder1.ui_uctlGridPendingOrder.Columns[e.ColumnIndex].DataPropertyName + " " + dir;
            //    var dt = new DataTable();
            //    dt = dv.ToTable();
            //    uctlPendingOrder1.ui_uctlGridPendingOrder.DataSource = dt; 
            //}
        }
        private void OnProfileApplyClick(string profileName)
        {
            ...
            foreach (DataGridViewColumn col in uctlPendingOrder1.ui_uctlGridPendingOrder.Columns)
            {
        ...
        private void ApplyDefaultProfile(string profileName)
        {
            ...
            uctlPendingOrder1.CurrentProfileName =
        ...
        {
            if (uctlPendingOrder1.ui_uctlGridPendingOrder.Rows.Count > 0)
            {
                uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["SaveAs"].Enabled = true;
                string OrderStatus =
                    uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmStatus"].Value.ToString().ToUpper();
                ...
                {
                    uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["CancelOrder"].Enabled = false;
                    uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["ModifyOrder"].Enabled = false;
                }
                else
                {
                    uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["CancelOrder"].Enabled = true;
                    uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["ModifyOrder"].Enabled = true;
                }
                //uctlOrderBook1.ui_uctlGridOrderBook.ContextMenuStrip.Items["Filter"].Enabled = true;
            }
            else
            {
                uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["SaveAs"].Enabled = false;
                uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["CancelOrder"].Enabled = false;
                uctlPendingOrder1.ui_uctlGridPendingOrder.ContextMenuStrip.Items["ModifyOrder"].Enabled = false;
        ...
        private void dtOrderHistory_RowChanged(object sender, DataRowChangeEventArgs e)
        {
            ...
            if (uctlPendingOrder1.ui_uctlGridPendingOrder.Rows.Count != 0 &&
                uctlPendingOrder1.ui_uctlGridPendingOrder.Rows[y] != null)
            {
                x = e.Row["Color"].ToString();

                uctlPendingOrder1.ui_uctlGridPendingOrder.Rows[y].DefaultCellStyle.BackColor = Color.FromName(x);
                uctlPendingOrder1.ui_uctlGridPendingOrder.Rows[y].Cells["clmStatus"].Value = e.Row["OrderStatus"].ToString();
                uctlPendingOrder1.ui_uctlGridPendingOrder.Rows[y].Cells["clmAvgPrice"].Value = e.Row["AvgPrice"].ToString();
                uctlPendingOrder1.ui_uctlGridPendingOrder.Rows[y].Cells["clmTotalExecutedQuantity"].Value =
                    e.Row["CumQty"].ToString();
            }
            //}
        }

        public void uctlPendingOrder1_HandleCancelOrderClick(object arg1, EventArgs arg2)
        {
            ...
            if (uctlPendingOrder1.ui_uctlGridPendingOrder.Rows.Count > 0)
            {
                    ...
                    DateTime.TryParse(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmTransactionTime"].Value.ToString(), out transactTime);
                    double transTime = transactTime.ToOADate();
                    DateTime.TryParse(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmSeriesExpiry"].Value.ToString(), out expiryDateTime);
                    string pType = uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmProductType"].Value.ToString();
                    switch (pType)
                    {
                        case "Equity":
                            pType = "EQ";
                    ...
                    ;
                    sbyte ordType = PALSA.Cls.ClsGlobal.DDOrderTypes[uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmOrderType"].Value.ToString()];
                    sbyte side = PALSA.Cls.ClsGlobal.DDSide[uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmBS"].Value.ToString()];
                    uint Account = Convert.ToUInt32(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmClient"].Value.ToString());
                    string clOrdId = uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmOrderNumber"].Value.ToString();
                    string ContractName = uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmContract"].Value.ToString();
                    string ProductType = uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmProductType"].Value.ToString();
                    sbyte Producttype = PALSA.Cls.ClsGlobal.DDProductTypes[pType];
                    double ordQty = Convert.ToDouble(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmOrderQuantity"].Value.ToString());
                    double price = 0;
                    if (!string.IsNullOrEmpty(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmPrice"].Value.ToString()))
                        price = Convert.ToDouble(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmPrice"].Value.ToString());
                    double stopPx = Convert.ToDouble(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmTriggerPrice"].Value.ToString());
                    sbyte tif = PALSA.Cls.ClsGlobal.DDValidity[uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmValidity"].Value.ToString()];
                //Namo 21 March
                //clsTWSOrderManagerJSON.INSTANCE.CancelOrder(Account, clOrdId, ContractName, ProductType, Producttype,
                //                                        uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmProductName"].Value.ToString(), expiryDateTime,
                //                                        uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmGateway"].Value.ToString(),
                //                                        Convert.ToUInt32(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0].Cells["clmOrderNumber"].Value.ToString()), side,
        ...
        {
            frmOrderEntry orderentry = new frmOrderEntry(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0], CommonLibrary.Cls.ClsGlobal.OrderMode.MODIFY);
        ...
        {
            uctlPendingOrder1.CurrentProfileName = profileName;
        ...
        private void uctlPendingOrder1_HandleModifyOrderClick(object arg1, EventArgs arg2)
        {
            if (uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows != null && uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows.Count > 0)
            {
                frmOrderEntry orderentry = new frmOrderEntry(uctlPendingOrder1.ui_uctlGridPendingOrder.SelectedRows[0], CommonLibrary.Cls.ClsGlobal.OrderMode.MODIFY);
                orderentry.ShowDialog();
            }
